        ...
        <div className="min-h-screen bg-white">
            ...
            >
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-12 relative z-10 py-12 lg:py-16">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#0F3C53]/20 bg-[#0F3C53]/5 mb-4">
                            <LuShieldCheck className="w-3.5 h-3.5 text-[#0F3C53]" />
                            <span className="text-[10px] font-bold uppercase tracking-widest text-[#0F3C53] font-eyebrow" style={{ fontFamily: "Poppins, sans-serif" }}>
                                {isBn ? "লিগ্যাল" : "Legal"}
                            </span>
                        </div>
                        <h1
