...
const SEEN_KEY = "aerovista-preloaded";
                    ...
                    >
                        ...
                        <div className="relative mb-9 flex h-48 w-48 items-center justify-center">
                            ...
                            >
                                <Logo
                                    dark
                                    className="h-14 w-auto max-w-[130px]"
                                    badgeClassName="!p-3 rounded-2xl shadow-2xl shadow-black/40 ring-1 ring-white/10"
                                />
                            </motion.div>
                        </div>
                        ...
                        {/* Tagline */}
                        <motion.p
                            className="mb-9 text-[11px] font-semibold uppercase tracking-[0.5em] text-white/45 font-eyebrow"
                        ...
                        <div className="flex w-72 flex-col items-center">
                            <div className="mb-3 flex w-full items-baseline justify-between">
                                <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-white/40 font-eyebrow">
                                    Loading
                                </span>
