...
export default function ImageInput({
    ...
    const defaultInput =
        "w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm outline-none focus:border-[#0F3C53] bg-transparent";
        ...
        <div>
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className="flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-2.5 rounded-lg bg-[#0F3C53] text-white text-[12px] font-bold hover:opacity-90 disabled:opacity-50 cursor-pointer"
                >
        ...
        <div>
            ...
            <div className="flex items-center gap-2">
                <input
                    ...
                    disabled={disabled}
                    className="flex-1 min-w-0 px-3 py-2.5 border border-gray-200 rounded-lg text-sm outline-none focus:border-[#0F3C53] bg-transparent"
                />
                <button
                    type="button"
                    onClick={addUrl}
