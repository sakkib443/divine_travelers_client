...
export default function Services({ servicesData }) {
    ...
    const services = sd.items?.length
        ...
        : [
            { title: t('flightBooking'), subtitle: t('flightBookingSub'), description: t('flightBookingDesc'), icon: <LuPlane />, image: "https://images.pexels.com/photos/46148/aircraft-jet-landing-cloud-46148.jpeg?auto=compress&cs=tinysrgb&w=800", color: "#E64266", stats: t('flightBookingStats'), href: "/contact" },
    ...
    return (
        <section className="relative py-28 overflow-hidden bg-[#F8FAFC]">
            ...
            <div className="absolute top-0 right-[5%] w-[500px] h-[500px] rounded-full opacity-40 blur-[120px]" style={{ background: 'radial-gradient(circle, #0F3C5320, transparent)' }} />
            <div className="absolute bottom-0 left-[5%] w-[400px] h-[400px] rounded-full opacity-30 blur-[120px]" style={{ background: 'radial-gradient(circle, #E6426620, transparent)' }} />

            {/* Floating Particles */}
            <motion.div
                animate={{ y: [-20, 20, -20], rotate: [0, 180, 360] }}
                transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
                className="absolute top-[15%] right-[15%] w-3 h-3 rounded-full bg-[#0F3C53]/20"
            />
            <motion.div
            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-10 relative z-10">
                ...
                <div className="text-center mb-14">
                    ...
                    >
                        <div className="h-[1px] w-12 bg-gradient-to-r from-transparent to-[#E64266]" />
                        <div className="flex items-center gap-2 px-5 py-2 rounded-full border border-[#E64266]/15 bg-[#E64266]/[0.05]">
                            <LuSparkles className="text-[#E64266] text-sm" />
                            <span className="text-[#E64266] text-xs font-semibold tracking-[0.25em] uppercase font-eyebrow" style={{ fontFamily: bnFont || '"Poppins", sans-serif' }}>
                                {sd.tagText ? bt(sd.tagText) : t('servicesTag')}
                            </span>
                        </div>
                        <div className="h-[1px] w-12 bg-gradient-to-l from-transparent to-[#E64266]" />
                    </motion.div>
                    ...
                    >
                        {sd.heading ? bt(sd.heading) : t('servicesTitle')} <span className="text-[#0F3C53]">{sd.headingHighlight ? bt(sd.headingHighlight) : t('servicesTitleHighlight')}</span>
                    </motion.h2>
                            ...
                            >
                                ...
                                <div className="relative h-44 overflow-hidden">
                                    ...
                                    <div className="absolute bottom-4 left-4">
                                        <span className="text-white/60 text-[10px] font-bold tracking-[0.2em] uppercase font-eyebrow" style={{ fontFamily: bnFont || '"Poppins", sans-serif' }}>
                                            {service.subtitle}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="p-5 flex-grow flex flex-col">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {/* Service Number */}
                                        <span className="text-gray-200 text-3xl font-black select-none" style={{ fontFamily: 'var(--font-heading)' }}>
                ...
                <div className="flex items-center justify-center gap-3 mt-10">
                    <button className="services-prev w-12 h-12 rounded-full border-2 border-gray-200 flex items-center justify-center text-gray-400 hover:border-[#0F3C53] hover:text-[#0F3C53] hover:bg-[#0F3C53]/5 transition-all duration-300">
                        <LuChevronLeft className="text-xl" />
                    </button>
                    <button className="services-next w-12 h-12 rounded-full border-2 border-gray-200 flex items-center justify-center text-gray-400 hover:border-[#0F3C53] hover:text-[#0F3C53] hover:bg-[#0F3C53]/5 transition-all duration-300">
                ...
                >
                    <div className="flex items-center gap-3">
                        <div className="flex -space-x-2">
                            {['#0F3C53', '#E64266', '#10B981', '#8B5CF6'].map((color, i) => (
                                <div
                                    key={i}
