    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-white flex items-center justify-center">
                <LuLoader className="w-10 h-10 text-[#E64266] animate-spin" />
            </div>
        );
    }
    ...
    if (!blog) {
        return (
            <div className="min-h-screen bg-white flex flex-col items-center justify-center gap-4">
                <h2 className="text-3xl font-bold text-gray-900 uppercase" style={{ fontFamily: 'var(--font-heading)' }}>
                    {isBn ? 'ব্লগ পোস্ট পাওয়া যায়নি' : 'BLOG POST NOT FOUND'}
                </h2>
                <Link href="/blog" className="text-[#0F3C53] hover:underline text-sm font-medium">
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative overflow-hidden border-b border-gray-200" style={{ background: 'linear-gradient(135deg, #f0f5fa 0%, #e8eff7 40%, #eef4f9 100%)' }}>
                ...
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0F3C53]/5 rounded-full blur-[120px] -mr-32 -mt-32" />
                    <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-[#E64266]/5 rounded-full blur-[100px] -ml-20 -mb-20" />
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                    ...
                    <div className="pt-8 pb-4">
                        <Link
                            href="/blog"
                            className="inline-flex items-center gap-2 text-gray-400 hover:text-[#0F3C53] transition-colors text-sm font-medium"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center pb-12 lg:pb-16">
                        ...
                        >
                            ...
                            {blog.tags?.length > 0 && (
                                <div className="flex flex-wrap gap-2 mb-5">
                                    {blog.tags.slice(0, 3).map((tag) => (
                                        <span
                                            key={tag}
                                            className="px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-widest border border-[#0F3C53]/20 text-[#0F3C53]/70 bg-[#0F3C53]/5 font-eyebrow"
                                            style={{ fontFamily: 'Poppins, sans-serif' }}
                                        >
                                            {tag}
                                        </span>
                            ...
                            <div className="flex flex-wrap items-center gap-5" style={{ fontFamily: 'Poppins, sans-serif' }}>
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#0F3C53] to-[#2A74A8] flex items-center justify-center text-white text-xs font-bold shadow-md shadow-[#0F3C53]/15">
                                        {authorInitials}
                                    </div>
                                    <div>
                        ...
                        >
                            ...
                            {/* Decorative ring */}
                            <div className="absolute -bottom-4 -right-4 w-32 h-32 border-2 border-[#E64266]/15 rounded-2xl -z-10" />
                            <div className="absolute -top-3 -left-3 w-20 h-20 border-2 border-[#0F3C53]/10 rounded-xl -z-10" />
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <motion.article
                        ...
                        className="prose prose-lg max-w-none 
                            ...
                            prose-a:text-[#0F3C53] prose-a:no-underline hover:prose-a:underline
                    ...
                    {blog.tags?.length > 0 && (
                        <div className="mt-14 pt-8 border-t border-gray-100">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="text-xs font-bold text-gray-400 uppercase tracking-widest font-eyebrow" style={{ fontFamily: 'Poppins, sans-serif' }}>
                                    {isBn ? 'ট্যাগ' : 'Tags'}
                                </span>
                            </div>
                            <div className="flex flex-wrap gap-2">
                                {blog.tags.map((tag) => (
                                    <span
                                        key={tag}
                                        className="px-4 py-1.5 bg-gray-50 border border-gray-100 rounded-full text-xs font-semibold text-gray-500 hover:bg-[#0F3C53]/5 hover:border-[#0F3C53]/20 hover:text-[#0F3C53] transition-all cursor-default"
                                        style={{ fontFamily: 'Poppins, sans-serif' }}
                                    >
                                        {tag}
                                    </span>
                    ...
                    >
                        <div className="absolute top-0 right-0 w-48 h-48 bg-[#0F3C53]/10 rounded-full blur-[60px]" />
                        <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#E64266]/10 rounded-full blur-[50px]" />

                        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6">
                            <div className="flex-1">
                                <h3 className="text-2xl md:text-3xl font-bold text-white uppercase mb-2" style={{ fontFamily: 'var(--font-heading)' }}>
                                ...
                                <p className="text-white/50 text-sm" style={{ fontFamily: 'Poppins, sans-serif' }}>
                                    {isBn
                                        ...
                                        : 'Our expert team is here to help you plan every part of your journey.'}
                                </p>
                            </div>
                            <Link
                                href="/contact"
                                className="inline-flex items-center gap-2 px-7 py-3.5 text-white rounded-xl font-bold text-xs uppercase tracking-wider transition-all hover:-translate-y-0.5 shadow-lg shadow-[#E64266]/30 shrink-0"
                ...
                <section className="py-16 border-t border-gray-100" style={{ background: '#f8fafb' }}>
                    <div className="max-w-7xl mx-auto px-6 lg:px-12">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-1 h-8 rounded-full bg-[#E64266]" />
                            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 uppercase" style={{ fontFamily: 'var(--font-heading)' }}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {relatedPosts.slice(0, 3).map((post, i) => (
                                ...
                                >
                                    <Link
                                        href={`/blog/${post.slug}`}
                                        className="group bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-[#E64266]/20 hover:shadow-xl transition-all duration-500 block"
                                    >
                                        ...
                                        <div className="p-5">
                                            <h3 className="font-bold text-gray-900 mt-1 line-clamp-2 uppercase group-hover:text-[#E64266] transition-colors text-lg" style={{ fontFamily: 'var(--font-heading)' }}>
