...
function CreateForm() {
    ...
    if (fetching) return (
        <div className="flex justify-center py-20">
            <div className="text-center"><FaKaaba size={30} className="mx-auto mb-3 animate-pulse" style={{ color: '#E64266' }} /><p className="text-gray-400 text-sm">Loading package...</p></div>
        </div>
    );
    ...
    return (
        <div className="p-4 lg:p-6 max-w-5xl mx-auto">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-black uppercase tracking-tight" style={{ fontFamily: 'var(--font-heading)', color: '#021E14' }}>{editId ? "Edit" : "Create"} Hajj/Umrah Package</h1>
            ...
            <motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-5">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 p-5">
                    <div className="flex items-center gap-2 mb-4">
                        <FaKaaba size={14} style={{ color: '#E64266' }} />
...
export default function CreateHajjUmrahPage() {
    return (<Suspense fallback={<div className="flex justify-center py-20"><FaKaaba size={30} className="animate-pulse" style={{ color: '#E64266' }} /></div>}><CreateForm /></Suspense>);
}
