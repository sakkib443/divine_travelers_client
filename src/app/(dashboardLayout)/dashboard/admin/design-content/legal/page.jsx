        ...
        <div className="p-6 max-w-4xl mx-auto">
                ...
                {POLICY_TABS.map((tab) => (
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold border transition-colors cursor-pointer ${activeType === tab.type
                            ? "bg-[#0F3C53] text-white border-[#0F3C53]"
            ...
            {loading ? (
                <div className="flex justify-center py-24">
                    <FiLoader className="w-8 h-8 text-[#0F3C53] animate-spin" />
                </div>
            ) : (
                    ...
                    <section className="bg-white rounded-xl border border-gray-100 p-6">
                        ...
                        <div className="flex items-center justify-between gap-3 mb-5">
                            <div className="inline-flex rounded-lg border border-gray-200 p-0.5 bg-gray-50">
                                {LANG_TABS.map((lang) => (
                                    <button
                                        ...
                                        className={`px-4 py-1.5 rounded-md text-sm font-semibold transition-colors cursor-pointer ${activeLang === lang.key ? "bg-white text-[#0F3C53] shadow-sm" : "text-gray-500"
                                            }`}
                                    >
                                        {lang.label}
                                    </button>
                            ...
                            <Link
                                href={activeTab.href}
                                target="_blank"
                                className="flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-[#0F3C53]"
                            >
                        ...
                        <div className="mb-5">
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-800 outline-none focus:border-[#0F3C53] focus:ring-2 focus:ring-[#0F3C53]/10 transition-all"
                            />
                        </div>
