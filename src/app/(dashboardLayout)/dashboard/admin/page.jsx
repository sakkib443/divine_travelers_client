...
// ==================== MINI CHART ====================
const MiniChart = ({ data, color = "#E64266" }) => {
...
export default function AdminDashboard() {
    ...
    const getStatusStyle = (status) => {
        switch (status) {
            ...
            case "processing": return "bg-[#0F3C53]/5 text-[#0F3C53] border border-[#0F3C53]/10";
    ...
    const quickActions = [
        ...
        { name: "New Client", href: "/dashboard/admin/users/create", icon: FiUsers, color: "#E64266" },
    ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                >
                    <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700/50">
                        <div>
                            ...
                            <p className="text-[10px] text-gray-400 mt-0.5">Latest booking updates</p>
                        </div>
                        <Link href="/dashboard/admin/bookings" className="text-[11px] font-semibold flex items-center gap-1 hover:underline" style={{ color: '#E64266' }}>
                ...
                >
                    <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700/50">
                        ...
                        <Link href="/dashboard/admin/tours" className="text-[11px] font-semibold flex items-center gap-1 hover:underline" style={{ color: '#E64266' }}>
